...
/**
 * <b>HttpResponse</b>接口的便利基础实现，处理 HTTP 的大多数<code>Connectors</code>所需的<code>Response</code>实现都可以使用它。
 * 只需要实现连接器特定的方法即可。
 * 
 * @author tequlia2pop
 * @deprecated
...
public class HttpResponseBase extends ResponseBase implements HttpResponse, HttpServletResponse {
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.connector.ResponseBase#getResponse()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.connector.ResponseBase#finishResponse()
	 */
	@Override
	public void finishResponse() throws IOException {
		// 如果创建了一个 >= 400 的 HTTP 错误（没有内容），请尝试创建一个简单的错误消息
		if (!isCommitted() && (stream == null) && (writer == null)
				&& (status >= HttpServletResponse.SC_BAD_REQUEST) && (contentType == null)
				&& (contentCount == 0)) {
			try {
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.HttpResponse#getCookies()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.HttpResponse#getHeader(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.HttpResponse#getHeaderNames()
	 */
	@Override
	public String[] getHeaderNames() {
		synchronized (headers) {
			String results[] = new String[headers.size()];
			return headers.keySet().toArray(results);
		}
	}

	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.HttpResponse#getHeaderValues(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.HttpResponse#getMessage()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.HttpResponse#getStatus()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.connector.ResponseBase#recycle()
	 */
	@Override
	public void recycle() {
		super.recycle();
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.HttpResponse#reset(int, java.lang.String)
	 */
	@Override
	...
	protected void sendHeaders() throws IOException {
		...
		// 发送 content-length 和 content-type 响应头（如果有的话）
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.connector.ResponseBase#flushBuffer()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.connector.ResponseBase#reset()
	 */
	@Override
	public void reset() {
		if (included)
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.connector.ResponseBase#setContentLength(int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.connector.ResponseBase#setContentType(java.lang.String)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.connector.ResponseBase#setLocale(java.util.Locale)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see org.apache.catalina.Response#sendAcknowledgement()
	 */
	@Override
