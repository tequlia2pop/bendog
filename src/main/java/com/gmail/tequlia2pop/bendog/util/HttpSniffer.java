package com.gmail.tequlia2pop.bendog.util;
...
/**
 * 创建一个套接字，用于与指定服务器进行通信，发送 HTTP 请求，接收服务器的响应信息。
 * 
 * 这里创建了一个 StringBuffer 对象来保存响应信息，并将其输出到控制台上。
 * 
 * @author tequlia2pop
 */
public class HttpSniffer extends JFrame {

	private static final long serialVersionUID = 4693345040121687089L;
